 ...
 * @author Akbar
 */
public class izinpesertadidik extends javax.swing.JFrame {
    ...
    private void aktif(){
        txtnoizinpesdik.setEnabled(true);
        txtnis.setEnabled(false);
        txtnmpesdik.setEnabled(false);
        txtkelas.setEnabled(false);
        laki.setEnabled(false);
        perempuan.setEnabled(false);
        txttelppesdik.setEnabled(false);
...
//        tglprint.setDate(tgl);
    ...
    public void datatable(){
         Object[] Baris = {"No Izin Pesdik","NIS","Nama Pesdik","Kelas","Jenis Kelamin","Telpon","Alasan","Tanggal Izin","Jam Izin","Jam Kembali","Keterangan"};
         tabmodel = new DefaultTableModel(null, Baris){
         public boolean isCellEditable(int row, int column) {
                return false;
            }
        };
         tblizinpesdik.setModel(tabmodel);
         String sql ="SELECT * FROM izinkeluarpesdik ORDER BY noizinpesdik ASC";
         try{
             java.sql.Statement stat = conn.createStatement();
             ResultSet hasil = stat.executeQuery(sql);
             while (hasil.next()){
                 String noizinpesdik = hasil.getString("noizinpesdik");
                 String nis = hasil.getString("nis");
                 String nm_pesdik = hasil.getString("nm_pesdik");
                 String kelas = hasil.getString("kelas");
                 String jk_pesdik = hasil.getString("jk_pesdik");
                 String telp_pesdik = hasil.getString("telp_pesdik");
                 String alasan_pesdik = hasil.getString("alasan_pesdik");
                 String tglizin = hasil.getString("tglizin_pesdik");
                 String jamizin = hasil.getString("jamizin_pesdik");
                 String jamkembali = hasil.getString("jamkem_pesdik");
                 String keterangan = hasil.getString("ket_pesdik");
                 
                 String[] data = {noizinpesdik, nis, nm_pesdik, kelas, jk_pesdik, telp_pesdik,alasan_pesdik, tglizin, jamizin, jamkembali, keterangan};
...
//                 lebarKolom();
    ...
    public void pencarian(String sql){
        Object[] Baris = {"No Izin Pesdik","NIS","Nama Pesdik","Kelas","Jenis Kelamin","Telpon","Alasan","Tanggal Izin","Jam Izin","Jam Kembali","Keterangan"};
         tabmodel = new DefaultTableModel(null, Baris);
         tblizinpesdik.setModel(tabmodel);
         int brs = tblizinpesdik.getRowCount();
         for (int i = 0; 1 < brs; i++){
...
//                 lebarKolom();
    ...
    try{
    String sql = "SELECT MAX(RIGHT(noizinpesdik,4)) AS NO FROM izinkeluarpesdik";
    Statement st=conn.createStatement();
    ResultSet visit = st.executeQuery(sql);
    while(visit.next()){
        if(visit.first() == false){
            txtnoizinpesdik.setText("IZINPESDIK0001");
        }else{
            visit.last();
            ...
            txtnoizinpesdik.setText("IZINPESDIK" + no);
        }
    }
    visit.close();
    st.close();
    ...
    /**
     * Creates new form izinpesertadidik
     */
    public izinpesertadidik() {
        initComponents();
        tampil_pesdik();
    ...
    private void initComponents() {
        ...
        tblpesdikadd = new javax.swing.JTable();
        jPanel9 = new javax.swing.JPanel();
        txtcaripesdik = new placeholder.caridata();
        btncaripesdik = new javax.swing.JButton();
        ...
        txtnoizinpesdik = new javax.swing.JTextField();
        ...
        txttelppesdik = new javax.swing.JTextField();
        ...
        tblizinpesdik = new javax.swing.JTable();
        jPanel4 = new javax.swing.JPanel();
        txtcari = new placeholder.cariizinpesdik();
        btnprint = new javax.swing.JButton();
        btnsearch = new javax.swing.JButton();
        txtprint = new placeholder.cetakizinpesdik();
        ...
        jLabel13.setText("DATA PESERTA DIDIK SMKN 8 JAKARTA");
        ...
        tblpesdikadd.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "NIS", "Nama Siswa", "Kelas", "Jenis Kelamin", "Telp Siswa", "Alamat Siswa"
            }
        ));
        tblpesdikadd.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblpesdikaddMouseClicked(evt);
            }
        });
        jScrollPane3.setViewportView(tblpesdikadd);

        jPanel9.setBackground(new java.awt.Color(255, 255, 255));
        jPanel9.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true), "SEARCH DATA PESERTA DIDIK", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 14))); // NOI18N

        txtcaripesdik.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtcaripesdikKeyPressed(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtcaripesdikKeyTyped(evt);
            }
        });

        btncaripesdik.setFont(new java.awt.Font("Gobold", 0, 14)); // NOI18N
        btncaripesdik.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/magnifier.png"))); // NOI18N
        btncaripesdik.setText("SEARCH");
        btncaripesdik.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btncaripesdikActionPerformed(evt);
            }
        });
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                .addComponent(txtcaripesdik)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(btncaripesdik)
                .addGap(19, 19, 19))
        );
        jPanel9Layout.setVerticalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btncaripesdik)
                    .addComponent(txtcaripesdik, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        setTitle("DATA IZIN PESDIK SMKN 8 JAKARTA");
        ...
        jLabel6.setText("FORM IZIN PESERTA DIDIK SMKN 8 JAKARTA");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "FORM IZIN PESERTA DIDIK", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial Black", 0, 12))); // NOI18N

        jLabel1.setFont(new java.awt.Font("Gobold", 0, 18)); // NOI18N
        jLabel1.setText("NO IZIN PESDIK");

        txtnoizinpesdik.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N

        jLabel2.setFont(new java.awt.Font("Gobold", 0, 18)); // NOI18N
        jLabel2.setText("NIS");

        jLabel3.setFont(new java.awt.Font("Gobold", 0, 18)); // NOI18N
        jLabel3.setText("NAMA PESDIK");

        jLabel4.setFont(new java.awt.Font("Gobold", 0, 18)); // NOI18N
        jLabel4.setText("ALASAN PESDIK");
        ...
        alasanbox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--SILAHKAN PILIH ALASAN--", "SAKIT", "TEKNIKAL MEETING", "LOMBA", "DINAS", "LATIHAN PRA LOMBA", "LAINNYA" }));
        ...
        btntbltamu.setText("LIHAT TABLE DATA PESERDA DIDIK");
        ...
        jLabel8.setFont(new java.awt.Font("Gobold", 0, 18)); // NOI18N
        jLabel8.setText("KELAS");

        txtkelas.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N

        jLabel10.setFont(new java.awt.Font("Gobold", 0, 18)); // NOI18N
        jLabel10.setText("TELP PESDIK");

        txttelppesdik.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addGroup(jPanel3Layout.createSequentialGroup()
                                    ...
                                    .addGap(45, 45, 45)
                                    .addComponent(txttelppesdik, javax.swing.GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE))
                                .addGroup(jPanel3Layout.createSequentialGroup()
                                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addComponent(txtnmpesdik, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE)
                                        .addComponent(txtnis, javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(txtnoizinpesdik, javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createSequentialGroup()
                                    ...
                                    .addGap(18, 18, 18)
                                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addComponent(alasanbox, javax.swing.GroupLayout.Alignment.LEADING, 0, 330, Short.MAX_VALUE)
                                        .addComponent(tanggalizin, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(jamizinbox, javax.swing.GroupLayout.Alignment.LEADING, 0, 330, Short.MAX_VALUE)
                                        .addComponent(jamkembalibox, javax.swing.GroupLayout.Alignment.LEADING, 0, 330, Short.MAX_VALUE))))))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(149, 149, 149)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(txtnoizinpesdik, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel10)
                    .addComponent(txttelppesdik, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "TABEL IZIN PESERTA DIDIK"));

        tblizinpesdik.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "No Izin Pesdik", "NIS", "Nama Pesdik", "Kelas", "Jenis Kelamin", "Telpon", "Alasan", "Tanggal Izin", "Jam Izin ", "Jam Kembali", "Keterangan"
            }
        ));
        tblizinpesdik.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblizinpesdikMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(tblizinpesdik);
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtcari, javax.swing.GroupLayout.DEFAULT_SIZE, 420, Short.MAX_VALUE)
                    .addComponent(txtprint, javax.swing.GroupLayout.DEFAULT_SIZE, 420, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        if(txtnoizinpesdik.getText().equals("")){
            ...
            if (ok == JOptionPane.YES_OPTION){
                String sql = "insert into izinkeluarpesdik values (?,?,?,?,?,?,?,?,?,?,?)";
                ...
                try{
                    ...
                    stat.setString(1, txtnoizinpesdik.getText());
                    stat.setString(2, txtnis.getText());
                    stat.setString(3, txtnmpesdik.getText());
                    stat.setString(4, txtkelas.getText());
                    String jkel="";
                    if(laki.isSelected()) jkel="Laki-Laki";
                    else jkel="Perempuan";
                    stat.setString(5, jkel);
                    stat.setString(6, txttelppesdik.getText());
                    stat.setString(7, alasanbox.getSelectedItem().toString());
                    stat.setString(8, tanggal.toString());
                    stat.setString(9, jamizinbox.getSelectedItem().toString());
                    stat.setString(10, jamkembalibox.getSelectedItem().toString());
    ...
    private void btneditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditActionPerformed
        // TODO add your handling code here:
        int baris = tblizinpesdik.getSelectedRow();
        if(baris >= 0 ){
            String nis = tblizinpesdik.getValueAt(baris, 1).toString();
            String  nm_pesdik = tblizinpesdik.getValueAt(baris, 2).toString();
            ...
            if (ok == JOptionPane.YES_OPTION){
                try{
                    ...
                    String sql = "update izinkeluarpesdik set noizinpesdik=?, nis=?, nm_pesdik=?, kelas=?, jk_pesdik=?, "
                            + "telp_pesdik=?, alasan_pesdik=?, tglizin_pesdik=?, jamizin_pesdik=?, jamkem_pesdik=?, ket_pesdik=? where noizinpesdik='" + txtnoizinpesdik.getText()+"'";
                    PreparedStatement stat = conn.prepareStatement(sql);
                    String tampilan = "dd-MM-yyyy";
                    SimpleDateFormat fm = new SimpleDateFormat(tampilan);
                    String tanggal = String.valueOf(fm.format(tanggalizin.getDate()));
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        if(baris >= 0 ){
            ...
            int ok = JOptionPane.showConfirmDialog(null, "Data Izin Keluar Pesdik dengan \n\nNIS : "+nis+"\nNama Pesdik : "+nm_pesdik+ "\nAkan Anda Hapus, Yakin? ", "Konfirmasi", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
            if(ok == JOptionPane.YES_OPTION){
                String sql = "delete from izinkeluarpesdik where noizinpesdik ='" + txtnoizinpesdik.getText()+"'";
                try{
                    PreparedStatement stat = conn.prepareStatement(sql);
                    stat.executeUpdate();
    ...
    private void tblizinpesdikMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblizinpesdikMouseClicked
        // TODO add your handling code here:
        int bar = tblizinpesdik.getSelectedRow();
        ...
        String k = tabmodel.getValueAt(bar, 10). toString();

        SimpleDateFormat date = new SimpleDateFormat("dd-MM-yyyy");
        Date dateValue = null;
        try{
            dateValue = date.parse((String) tblizinpesdik.getValueAt(bar, 7));
        }catch (ParseException ex){
            Logger.getLogger(kunjungan.class.getName()).log(Level.SEVERE, null, ex);
        }

        txtnoizinpesdik.setText(a);
        txtnis.setText(b);
        txtnmpesdik.setText(c);
        txtkelas.setText(d);
        if(e.equals("Laki-Laki")) {laki.setSelected(true); perempuan.setSelected(false);}
        else {laki.setSelected(false); perempuan.setSelected(true);}
        txttelppesdik.setText(f);
        alasanbox.setSelectedItem(g);
        tanggalizin.setDate(dateValue);
        jamizinbox.setSelectedItem(i);
        jamkembalibox.setSelectedItem(j);
        txtket.setText(k);
    }//GEN-LAST:event_tblizinpesdikMouseClicked

    private void txtcariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcariKeyPressed
        // TODO add your handling code here:
        String sqlPencarian = "select * from izinkeluarpesdik where nm_pesdik like '%" + txtcari.getText() + "%' or "
        + "alasan_pesdik like '%" + txtcari.getText() + "%' or "
        + "noizinpesdik like '%" + txtcari.getText() + "%' or "
        + "nis like '%" + txtcari.getText() + "%' or "
        + "jamkem_pesdik like '%" + txtcari.getText() + "%' or "
        + "kelas like '%" + txtcari.getText() + "%' or "
        + "jk_pesdik like '%" + txtcari.getText() + "%' or "
        + "telp_pesdik like '%" + txtcari.getText() + "%' or "
        + "tglizin_pesdik like '%" + txtcari.getText() + "%' or "
        + "jamizin_pesdik like '%" + txtcari.getText() + "%' or "
        + "ket_pesdik like '%" + txtcari.getText() + "%'";
    ...
    private void btnprintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnprintActionPerformed
        ...
        try{
            ...
            try{
                ...
                String report = ("src/tandabukti/izinkeluarpesdik.jrxml");
                HashMap hash = new HashMap();
                //mengambil parameter ireport
                hash.put("No_Izin_Pesdik", txtprint.getText());
    ...
    private void tblpesdikaddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblpesdikaddMouseClicked
        // TODO add your handling code here:
        clicktbl_pesdik();
    }//GEN-LAST:event_tblpesdikaddMouseClicked

    private void txtcaripesdikKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcaripesdikKeyPressed
        // TODO add your handling code here:
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            search_pesdik();
        }
    }//GEN-LAST:event_txtcaripesdikKeyPressed

    private void txtcaripesdikKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcaripesdikKeyTyped
        // TODO add your handling code here:
        search_pesdik();
    }//GEN-LAST:event_txtcaripesdikKeyTyped

    private void btncaripesdikActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncaripesdikActionPerformed
        // TODO add your handling code here:
        search_pesdik();
    }//GEN-LAST:event_btncaripesdikActionPerformed
    ...
    private void btnhome1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnhome1ActionPerformed
        // TODO add your handling code here:
        DefaultTableModel model = (DefaultTableModel)tblizinpesdik.getModel();
        model.setRowCount(0);
        datatable();
        otomatis();
        kosong();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(izinpesertadidik.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void search_pesdik(){
        String query = txtcaripesdik.getText();
        ...
        try {
             String sql = "SELECT * FROM pesdik WHERE BINARY "
                    + "nis LIKE '%"+query+"%' "
                    + "OR nm_pesdik LIKE '%"+query+"%' "
                    + "OR kelas LIKE '%"+query+"%' "
                    + "OR jk_pesdik LIKE '%"+query+"%' "
                    + "OR telp_pesdik LIKE '%"+query+"%' "
                    + "OR almt_pesdik LIKE '%"+query+"&' "
                    + "ORDER BY nis ASC";
            java.sql.Statement stat = conn.createStatement();
    ...
    private void clicktbl_pesdik() {
        int baris = tblpesdikadd.getSelectedRow();
        
        String d = tbl1.getValueAt(baris, 3).toString();
        
        txtnis.setText((String)tbl1.getValueAt(baris, 0));
        txtnmpesdik.setText((String)tbl1.getValueAt(baris, 1));
        txtkelas.setText((String)tbl1.getValueAt(baris, 2));
        txttelppesdik.setText((String)tbl1.getValueAt(baris, 4));
    ...
    private javax.swing.JButton btncaripesdik;
    ...
    private javax.swing.JTable tblizinpesdik;
    private javax.swing.JTable tblpesdikadd;
    private javax.swing.JDialog tblpesdikview;
    private javax.swing.JTextField txtcari;
    private javax.swing.JTextField txtcaripesdik;
    private javax.swing.JTextField txtkelas;
    private javax.swing.JTextArea txtket;
    private javax.swing.JTextField txtnis;
    private javax.swing.JTextField txtnmpesdik;
    private javax.swing.JTextField txtnoizinpesdik;
    private javax.swing.JTextField txtprint;
    private javax.swing.JTextField txttelppesdik;
