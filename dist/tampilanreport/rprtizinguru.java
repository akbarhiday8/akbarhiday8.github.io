 ...
 * @author Akbar
 */
public class rprtizinguru extends javax.swing.JFrame {
...
//                 lebarKolom();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("LAPORAN PARAMETER IZIN GURU SMKN 8 JAKARTA");
    ...
    private void btncetakpertanggalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncetakpertanggalActionPerformed
        ...
        try{
            ...
            try{
                ...
                String report = ("src/laporan/rprtizinguru.jrxml");
    ...
    private void btnprintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnprintActionPerformed
        ...
        try{
            ...
            try{
                ...
                String report = ("src/laporan/kolomizinguru.jrxml");
                HashMap hash = new HashMap();
                //mengambil parameter ireport
                hash.put("izinguru", txtcari.getText());
                JasperReport Jrpt = JasperCompileManager.compileReport(report);
                JasperPrint JPrint = JasperFillManager.fillReport(Jrpt, hash, con);
                JasperViewer.viewReport(JPrint, false);
            }catch (Exception rptexcpt){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rprtizinguru.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new rprtizinguru().setVisible(true);
            }
        });
    }
