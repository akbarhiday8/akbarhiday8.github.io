 ...
 * @author Akbar
 */
public class caridata extends JTextField {
    ...
    public caridata(String text) {
        initListener();
    }
    
    public caridata(int columns) {
        initListener();
    }
    
    public caridata(String text, int columns) {
        super(text, columns);
        initListener();
    }
    
    public caridata(Document doc, String text, int columns) {
