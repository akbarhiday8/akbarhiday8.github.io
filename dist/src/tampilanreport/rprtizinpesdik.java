 ...
 * @author Akbar
 */
public class rprtizinpesdik extends javax.swing.JFrame {
...
//                 lebarKolom();
    ...
    /**
     * Creates new form rprtizinpesdik
     */
    public rprtizinpesdik() {
        initComponents();
        datatable();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("LAPORAN PARAMETER IZIN PESERTA DIDIK SMKN 8 JAKARTA");
        ...
        setSize(new java.awt.Dimension(703, 656));
    ...
    private void btncetakpertanggalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncetakpertanggalActionPerformed
        ...
        try{
            ...
            try{
                ...
                String report = ("src/laporan/rprtizinpesdik.jrxml");
    ...
    private void btnprintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnprintActionPerformed
        ...
        try{
            ...
            try{
                ...
                String report = ("src/laporan/kolomizinpesdik.jrxml");
                HashMap hash = new HashMap();
                //mengambil parameter ireport
                hash.put("izinpesdik", txtcari.getText());
                JasperReport Jrpt = JasperCompileManager.compileReport(report);
                JasperPrint JPrint = JasperFillManager.fillReport(Jrpt, hash, con);
                JasperViewer.viewReport(JPrint, false);
            }catch (Exception rptexcpt){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rprtizinpesdik.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new rprtizinpesdik().setVisible(true);
            }
        });
    }
